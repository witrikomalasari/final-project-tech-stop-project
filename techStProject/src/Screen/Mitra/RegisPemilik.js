  ...
  return (
    <View style={styles.container}>
      <View style={styles.subcontainer}>
        ...
        <Text style={styles.midheader}>2/3. Business Owner</Text>
      </View>
      <ScrollView
        ...
        <View style={{flex: 1}}>
          <View style={styles.textinput}>
            ...
            <Text style={styles.txtajah}>Address</Text>
            <TextInput
              // onFocus={() => setFocus(true)}
              style={styles.txt}
              placeholder="Address"
            ...
            <Text style={styles.txtajah}>Domicile</Text>
            <TextInput
              // onFocus={() => setFocus(true)}
              style={styles.txt}
          ...
          <View style={styles.upload}>
            ...
            <Text style={styles.doc}>
              Please upload a photo of the following documents and fill in the
              required information (JPG / PDF max 1Mb)
            </Text>
          </View>
        </View>
